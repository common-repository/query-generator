...
This plugin focuses on building [query parameters](https://codex.wordpress.org/Class_Reference/WP_Query#Parameters) for WP_Query object and preview data based on the generated parameters. This is done through various UI component that the plugin provides.
...
1. **Parameters** - Showing the parameters UI
2. **Generated Code** - Showing the generated codes sample
3. **Data Preview** - Displaying sample data preview
